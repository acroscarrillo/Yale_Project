...
heatmap_combined = heatmap(ϵ_1_array,ϵ_2_array,combined_mat,xlab=L"\epsilon_1/K",ylab=L"\epsilon_2/K",title="",clim=(-5,5),titlefontsize=8,xtickfontsize=8,ytickfontsize=8,guidefont=font(10),height=400,c = :oleron100)#,xticks=([0,12],["0","12"]),yticks=([0,10],["0","10"])


################
# Area Heatmap #
################
x_array = Vector(range(-6,6,length=1000)) #it's a bit choppy but oh well
...
plot!(ϵ_1_array,(2*ϵ_1_array).^(2/3),ylim=(2.5,12.5),linestyle=:dash,legend=false,lw=2)

plot!(ϵ_1_array,(ϵ_1_array/1).^2,ylim=(2.5,12.5),legend=false,linewidth=2,ls=:dot)
plot!(ϵ_1_array,(ϵ_1_array/2).^2,ylim=(2.5,12.5),legend=false,linewidth=2,ls=:dot)
plot!(ϵ_1_array,(ϵ_1_array/3).^2,ylim=(2.5,12.5),legend=false,linewidth=2,ls=:dot)
plot!(ϵ_1_array,(ϵ_1_array/4).^2,ylim=(2.5,12.5),legend=false,linewidth=2,ls=:dot)

push!(plots,heatmap_combined)

scatter!(contour_line(left_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*1.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)
scatter!(contour_line(right_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*1.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)

scatter!(contour_line(left_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*2.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)
scatter!(contour_line(right_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*2.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)


scatter!(contour_line(left_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*3.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)
scatter!(contour_line(right_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*3.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)


scatter!(contour_line(left_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*4.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)
scatter!(contour_line(right_well_area_matrix,ϵ_1_array,ϵ_2_array,2*π*4.5, 0.05),ylim=(2.5,12),ms=2,alpha=0.2)