...
@df df plot(:ϵ_1, :ϵ_2, markersize = .5, xlab=L"\epsilon_1",ylab=L"\epsilon_2",seriestype=:scatter, legend=false,title=L"N="*string(N)*L",\Delta="*string(Δ)*L",K="*string(K)*",tol="*string(cross_tol))
